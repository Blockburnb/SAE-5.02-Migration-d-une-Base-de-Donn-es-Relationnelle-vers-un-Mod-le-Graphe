...
CREATE TABLE DIM_INFRACTIONS (
    id_infraction INT PRIMARY KEY,   -- Correspond à votre colonne 'code_index'
...
-- On utilise un ID auto-incrémenté car les noms des brigades sont du texte long
CREATE TABLE DIM_SERVICES (
    id_service SERIAL PRIMARY KEY,   -- Ou INTEGER PRIMARY KEY AUTOINCREMENT sous SQLite
